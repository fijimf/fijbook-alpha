...
class StatisticWriterServiceImpl @Inject()(dao: ScheduleDAO, @Named("data-load-actor") teamLoad: ActorRef, @Named("throttler") throttler: ActorRef) extends ScheduleUpdateService {
